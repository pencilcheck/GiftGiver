...
\begin{tikzpicture}
    \begin{axis}[x tick label style={/pgf/number format/1000 sep=}, ylabel=Weight, enlargelimits=0.15, legend style={at={(0.5, -0.15)}, anchor=north, legend columns=2}, ybar, bar width=7pt]
